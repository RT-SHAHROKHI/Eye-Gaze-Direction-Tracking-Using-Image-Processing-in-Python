...
we open the camera by putting 0 in "cap = cv2.VideoCapture()" and then we put it in a loop so tha we can loop through the frames of the video and process image by image.
